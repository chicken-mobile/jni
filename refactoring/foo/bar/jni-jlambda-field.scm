...
(define (make-getter-with-setter-variant modifier class-object field getter setter)
  (if (eq? modifier 'static) 
      (getter-with-setter (lambda ()               (getter class-object field)) 
			  (lambda (value)          (setter class-object field value)))
      (getter-with-setter (lambda (instance)       (getter instance field))
			  (lambda (instance value) (setter instance field value)))))
